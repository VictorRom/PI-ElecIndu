...
const MeditrakkerMapOld = ({ center_lat, center_lon, zoom }) => {
    ...
    useEffect(() => {
        ...
        if (!map){
            ...
            const map = new mapboxgl.Map({ // Cette partie crash -> erreur de fetch (NetworkError when attempting to fetch resource.)
                container: 'map',
                zoom: zoom,
